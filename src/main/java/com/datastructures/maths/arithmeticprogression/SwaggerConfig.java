...
@EnableSwagger2
@Configuration
@ComponentScan({ "com.datastructures.maths.arithmeticprogression.controller" })
public class SwaggerConfig implements WebMvcConfigurer {
	...
	public Docket userApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.datastructures.maths.arithmeticprogression.controller"))
				.build()
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder().title("API for printing Arithmetic progression of given numbers such as first, last and the difference").description("THis project is for learning the arithmetic progression of Data Structures").version("1.0.0").license("Apache 2.0").licenseUrl("http://www.apache.org/licenses/LICENSE-2.0")
				.build();
